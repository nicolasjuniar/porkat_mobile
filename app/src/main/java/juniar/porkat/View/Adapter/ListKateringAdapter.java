...
public class ListKateringAdapter extends RecyclerView.Adapter<ListKateringAdapter.ViewHolder> {
    ...
    public ListKateringAdapter(List<KateringModel> list, Context context, PreferenceHelper preferences) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(ListKateringAdapter.ViewHolder holder, int position) {
